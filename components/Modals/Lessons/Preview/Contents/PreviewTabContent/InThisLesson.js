        ...
        <div className="lessonDetails color-black--text fontSize-sm breakMd-fontSize-md lineHeight-xl breakMd-paddingRight-xl paddingLeft-xs">
          ...
          {modalData.lesson_type === 1 && (
            <span>
              ...
              <span className="hidden-xs hidden-sm">
                ...
                from beginner level etudes to the most awe-inspiring melodies in
                our catalog.
              </span>
            </span>
          )}
          {modalData.lesson_type === 2 && (
            <span>
              ...
              Interview covering the artists musical background, inspiratioons,
              advice, tips, tricks &amp; more.{" "}
              <span className="hidden-xs hidden-sm">
                tonebase Interviews are your inside look behind the lives of the
                some of the greatest performers, pedagogues and composers of our
                time.
              </span>
            </span>
          )}
