        ...
        >
          <div className="profileHeaderImage position-absolute t-0 l-0 r-0 w-100 h-100 bg-cover bg-no-repeat bg-center blackAnimated">
            <div className="profileHeaderContent">
              ...
              <div className="artistInfo position-absolute b-0 l-0 w-100 d-flex flex-row flex-noWrap paddingLeft-md paddingRight-md breakMd-paddingLeft-xl breakMd-paddingRight-xl paddingBottom-md">
                <div className="artistImage partImage d-flex alignItems-start justifyContent-center w-25 min-w-25 max-w-180px marginTop-xs breakMd-marginTop-0">
                  <div
                    className="artistImageInner position-relative w-100 h-0 bg-cover bg-no-repeat bg-center borderRadius-50 overflow-hidden blackAnimated pulseDark"
                    style={{
                      paddingTop: "100%"
                    }}
                  />
                ...
                <div className="artistDescription min-w-75 max-w-75 paddingLeft-md breakMd-paddingLeft-lg">
                  ...
                  <div className="artistTitle marginTop-sm">
                    <h4
