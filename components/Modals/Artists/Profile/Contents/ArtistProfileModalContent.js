...
function ArtistProfileModalContent(props) {
    ...
    <div className="modalContentInner d-flex flex-col paddingBottom-xxl">
      ...
      <div className="profileHeader w-100 min-w-100 cursor-pointer">
        ...
        >
          <div
            ...
            style={{
              backgroundImage: `linear-gradient(to bottom, rgba(0,0,0,0.6), rgba(16, 16, 18, 1) 70%), url(${`https://tonebase-nightingale.s3.us-east-2.amazonaws.com/images/artists/cards/lg/${modalSlug}.jpg`})`
            }}
          >
            <div className="profileHeaderContent">
              ...
              <div className="artistInfo position-absolute b-0 l-0 w-100 d-flex flex-row flex-noWrap paddingLeft-md paddingRight-md breakMd-paddingLeft-xl breakMd-paddingRight-xl">
                <div className="artistImage partImage d-flex alignItems-start justifyContent-center w-25 min-w-25 max-w-180px marginTop-xs breakMd-marginTop-0">
                  <div
                    ...
                    style={{
                      paddingTop: "100%",
                      backgroundImage: `url(${`https://tonebase-nightingale.s3.us-east-2.amazonaws.com/images/artists/profiles/lg/${modalSlug}.jpg`})`
                    }}
                  />
                </div>
                <div className="artistDescription min-w-75 max-w-75 paddingLeft-md breakMd-paddingLeft-lg">
                  ...
                  <div className="artistDescription hidden-xs hidden-sm paddingTop-xs paddingRight-xl">
      ...
      >
        <TabNav>
          ...
          <TabNavItem
            active={ModalStore.currentModalTab === "otherInstructors"}
            onClick={() => ModalStore.switchToModalTab("otherInstructors")}
          >
            Other Artists
          </TabNavItem>
        </TabNav>
...
export default view(ArtistProfileModalContent);
