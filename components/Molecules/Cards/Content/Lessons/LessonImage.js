        ...
        <div className="itemImageInner w-100 position-relative">
          ...
          >
            <div
              ...
              style={{
                backgroundImage: `url(${`https://tonebase-nightingale.s3.us-east-2.amazonaws.com/images/lessons/backgrounds/lg/${
                  this.props.slug
                }.jpg`})`
              }}
            >
              ...
              <div className="itemImageMetadata position-absolute w-100 h-100 z-2">
                <div className="itemDuration position-absolute t-0 r-0 marginTop-xs marginRight-xs d-inline-block paddingLeft-sm paddingRight-sm paddingTop-xxs paddingBottom-xxs lineHeight-sm bgColor-primary--darker color-white--main borderRadius-md">
                  <span className="fontSize-xxs breakLg-fontSize-xs fontFamily-primary textTransform-uppercase letterSpacing-md">
                    {this.props.total_length}
                  </span>
                </div>
              </div>
              {
